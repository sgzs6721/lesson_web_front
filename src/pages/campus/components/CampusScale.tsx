...
const CampusScale: React.FC<CampusScaleProps> = ({
  ...
  return (
    <div className="campus-scale-container">
      {/* Student count item */}
      <div className="scale-item scale-item-student">
      ...
      {/* Coach count item */}
      <div className="scale-item scale-item-coach">
        <div style={{ display: 'flex', alignItems: 'center' }}>
      ...
      <div className="scale-item scale-item-lesson">
        <div style={{ display: 'flex', alignItems: 'center' }}>
