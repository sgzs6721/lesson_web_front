      ...
      <section className="project-showcase">
        ...
        <div className="project-grid">
          ...
          <div className="project-card">
            <div className="project-card-img" style={{ background: 'linear-gradient(135deg, #5dade2, #85c1e9)' }}>
            ...
            <div className="project-card-title" style={{ backgroundColor: '#3498db' }}>
              <h4>运动培训</h4>
            </div>
          </div>
          ...
          {/* 学科培训 */}
          <div className="project-card">
            <div className="project-card-img" style={{ background: 'linear-gradient(135deg, #7fb3d5, #a9cce3)' }}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="80" height="80">
            ...
            <div className="project-card-title" style={{ backgroundColor: '#2980b9' }}>
              <h4>学科培训</h4>
            </div>
          </div>
          ...
          {/* 艺术培训 */}
          <div className="project-card">
            <div className="project-card-img" style={{ background: 'linear-gradient(135deg, #f1948a, #f5b7b1)' }}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="80" height="80">
            ...
            <div className="project-card-title" style={{ backgroundColor: '#e74c3c' }}>
              <h4>艺术培训</h4>
            </div>
          </div>
          ...
          {/* 编程培训 */}
          <div className="project-card">
            <div className="project-card-img" style={{ background: 'linear-gradient(135deg, #aab7b8, #cacfd2)' }}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="80" height="80">
            ...
            <div className="project-card-title" style={{ backgroundColor: '#7f8c8d' }}>
              <h4>编程培训</h4>
            </div>
          </div>
          ...
          {/* 演讲口才 */}
          <div className="project-card">
            <div className="project-card-img" style={{ background: 'linear-gradient(135deg, #bb8fce, #d2b4de)' }}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="80" height="80">
            ...
            <div className="project-card-title" style={{ backgroundColor: '#9b59b6' }}>
              <h4>演讲口才</h4>
            </div>
          </div>
          ...
          {/* 思维培训 */}
          <div className="project-card">
            <div className="project-card-img" style={{ background: 'linear-gradient(135deg, #73c6b6, #a3e4d7)' }}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="80" height="80">
            ...
            <div className="project-card-title" style={{ backgroundColor: '#16a085' }}>
              <h4>思维培训</h4>
            </div>
          </div>
          ...
          {/* 国学培训 */}
          <div className="project-card">
            <div className="project-card-img" style={{ background: 'linear-gradient(135deg, #f0b27a, #f5cba7)' }}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="80" height="80">
            ...
            <div className="project-card-title" style={{ backgroundColor: '#d35400' }}>
              <h4>国学培训</h4>
            </div>
          </div>
        </div>
